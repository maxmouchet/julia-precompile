...
precompile(Tuple{Type{Base.Dict{AbstractString, YAML.Node}}})
precompile(Tuple{typeof(YAML.forward!), YAML.EventStream})
precompile(Tuple{typeof(YAML.peek), YAML.EventStream})
precompile(Tuple{typeof(YAML.compose_node), YAML.Composer, Nothing, Nothing})
precompile(Tuple{typeof(Base.empty!), Base.Dict{AbstractString, YAML.Node}})
precompile(Tuple{typeof(YAML.compose_document), YAML.Composer})
precompile(Tuple{typeof(YAML.compose), YAML.EventStream})
precompile(Tuple{Type{Base.Dict{AbstractString, Function}}})
precompile(Tuple{Type{Base.Dict{YAML.Node, Any}}})
precompile(Tuple{Type{Base.Dict{YAML.Node, Nothing}}})
precompile(Tuple{typeof(Base._all), getfield(Base, Symbol("#240#242")), Base.Dict{Union{Nothing, AbstractString}, Function}, Base.Colon})
precompile(Tuple{Type{Base.Dict{K, V} where V where K}, Base.Dict{Union{Nothing, AbstractString}, Function}})
precompile(Tuple{typeof(Base.merge!), Base.Dict{Union{Nothing, AbstractString}, Function}, Base.Dict{AbstractString, Function}})
precompile(Tuple{Type{YAML.Constructor}, Base.Dict{AbstractString, Function}})
...
precompile(Tuple{getfield(Weave, Symbol("##weave#16")), Symbol, Symbol, Symbol, Base.Dict{Any, Any}, Symbol, String, Nothing, String, Symbol, Bool, Nothing, Nothing, Nothing, Array{String, 1}, String, typeof(Weave.weave), String})
...
precompile(Tuple{Type{NamedTuple{(:doctype, :mod, :out_path, :args, :fig_path, :fig_ext, :cache_path, :cache, :throw_errors), T} where T<:Tuple}, Tuple{String, Symbol, Symbol, Base.Dict{Any, Any}, String, Nothing, String, Symbol, Bool}})
...
precompile(Tuple{getfield(Weave, Symbol("##run#34")), String, Symbol, Symbol, Base.Dict{Any, Any}, String, Nothing, String, Symbol, Bool, typeof(Base.run), Weave.WeaveDoc})
precompile(Tuple{getfield(Base, Symbol("#kw##run")), NamedTuple{(:doctype, :mod, :out_path, :args, :fig_path, :fig_ext, :cache_path, :cache, :throw_errors), Tuple{String, Symbol, Symbol, Base.Dict{Any, Any}, String, Nothing, String, Symbol, Bool}}, typeof(Base.run), Weave.WeaveDoc})
...
precompile(Tuple{getfield(Weave, Symbol("##run#34")), String, Module, Symbol, Base.Dict{Any, Any}, String, Nothing, String, Symbol, Bool, typeof(Base.run), Weave.WeaveDoc})
...
precompile(Tuple{typeof(YAML.need_more_tokens), YAML.TokenStream})
...
precompile(Tuple{typeof(YAML.save_possible_simple_key), YAML.TokenStream})
...
precompile(Tuple{typeof(Base.:(==)), Nothing, UInt64})
...
precompile(Tuple{typeof(Base._all), getfield(Base, Symbol("#240#242")), Base.Dict{AbstractString, AbstractString}, Base.Colon})
precompile(Tuple{Type{Base.Dict{K, V} where V where K}, Base.Dict{AbstractString, AbstractString}})
...
precompile(Tuple{typeof(Base.ht_keyindex), Base.Dict{Any, Any}, UInt64})
precompile(Tuple{typeof(Base.haskey), Base.Dict{Any, Any}, UInt64})
precompile(Tuple{typeof(Base.ht_keyindex2!), Base.Dict{Any, Any}, UInt64})
precompile(Tuple{typeof(Base.setindex!), Base.Dict{Any, Any}, YAML.SimpleKey, UInt64})
precompile(Tuple{typeof(Base.string), Char, Char, Vararg{Char, N} where N})
precompile(Tuple{Type{YAML.ScalarToken}, YAML.Span, String, Bool, Nothing})
precompile(Tuple{typeof(Base.getproperty), YAML.SimpleKey, Symbol})
precompile(Tuple{typeof(Base.getproperty), YAML.Mark, Symbol})
precompile(Tuple{typeof(Base.:(!=)), UInt64, UInt64})
precompile(Tuple{typeof(Base.getindex), Base.Dict{Any, Any}, UInt64})
precompile(Tuple{typeof(Base.:(==)), UInt64, UInt64})
precompile(Tuple{typeof(Base._delete!), Base.Dict{Any, Any}, Int64})
precompile(Tuple{typeof(Base.delete!), Base.Dict{Any, Any}, UInt64})
precompile(Tuple{typeof(YAML.enqueue!), YAML.Queue{YAML.Token}, YAML.KeyToken, UInt64})
precompile(Tuple{typeof(YAML.add_indent), YAML.TokenStream, UInt64})
precompile(Tuple{typeof(YAML.enqueue!), YAML.Queue{YAML.Token}, YAML.BlockMappingStartToken, UInt64})
...
precompile(Tuple{getfield(YAML, Symbol("##parse_node#2")), Bool, Bool, typeof(YAML.parse_node), YAML.EventStream})
precompile(Tuple{typeof(YAML.parse_block_node), YAML.EventStream})
precompile(Tuple{Type{YAML.MappingStartEvent}, YAML.Mark, YAML.Mark, Nothing, Nothing, Bool, Bool})
...
precompile(Tuple{typeof(Base.getproperty), YAML.MappingStartEvent, Symbol})
precompile(Tuple{typeof(YAML.compose_node), YAML.Composer, YAML.MappingNode, Nothing})
precompile(Tuple{typeof(YAML.compose_mapping_node), YAML.Composer, Nothing})
precompile(Tuple{Type{YAML.MappingNode}, String, Array{Any, 1}, YAML.Mark, Nothing, Bool})
...
precompile(Tuple{Type{YAML.ScalarEvent}, YAML.Mark, YAML.Mark, Nothing, Nothing, Tuple{Bool, Bool}, String, Nothing})
...
precompile(Tuple{typeof(Base.getproperty), YAML.ScalarEvent, Symbol})
...
precompile(Tuple{typeof(Base.getindex), Array{Tuple{String, Base.Regex}, 1}, Int64})
precompile(Tuple{typeof(Base.indexed_iterate), Tuple{String, Base.Regex}, Int64})
precompile(Tuple{typeof(Base.indexed_iterate), Tuple{String, Base.Regex}, Int64, Int64})
precompile(Tuple{Type{YAML.ScalarNode}, String, String, YAML.Mark, YAML.Mark, Nothing})
precompile(Tuple{typeof(YAML.compose_node), YAML.Composer, YAML.MappingNode, YAML.ScalarNode})
precompile(Tuple{typeof(YAML.parse_block_mapping_value), YAML.EventStream})
precompile(Tuple{typeof(Base.setindex!), Array{Char, 1}, Char, Int64})
...
precompile(Tuple{typeof(Base.ht_keyindex), Base.Dict{Union{Nothing, AbstractString}, Function}, Nothing})
precompile(Tuple{getfield(YAML, Symbol("##construct_object#5")), Bool, typeof(YAML.construct_object), YAML.Constructor, YAML.MappingNode})
...
precompile(Tuple{typeof(Base.ht_keyindex), Base.Dict{Union{Nothing, AbstractString}, Function}, String})
precompile(Tuple{typeof(Base.haskey), Base.Dict{Union{Nothing, AbstractString}, Function}, String})
precompile(Tuple{typeof(Base.getindex), Base.Dict{Union{Nothing, AbstractString}, Function}, String})
precompile(Tuple{typeof(Base.vcat), Array{Any, 1}, Array{Any, 1}})
precompile(Tuple{typeof(YAML.flatten_mapping), YAML.MappingNode})
precompile(Tuple{getfield(YAML, Symbol("##construct_mapping#9")), Bool, typeof(YAML.construct_mapping), YAML.Constructor, YAML.MappingNode})
...
precompile(Tuple{getfield(YAML, Symbol("##construct_object#5")), Bool, typeof(YAML.construct_object), YAML.Constructor, YAML.ScalarNode})
precompile(Tuple{getfield(YAML, Symbol("#kw##construct_object")), NamedTuple{(:deep,), Tuple{Bool}}, typeof(YAML.construct_object), YAML.Constructor, YAML.ScalarNode})
...
precompile(Tuple{typeof(Base.collect_to_with_first!), Array{String, 1}, String, Base.Generator{Array{Base.SubString{String}, 1}, getfield(Weave, Symbol("#76#77"))}, Int64})
precompile(Tuple{typeof(Base.collect), Base.Generator{Array{Base.SubString{String}, 1}, getfield(Weave, Symbol("#76#77"))}})
...
precompile(Tuple{getfield(Weave, Symbol("##convert_doc#71")), Nothing, typeof(Weave.convert_doc), String, String})
...
precompile(Tuple{getfield(Base, Symbol("##open#271")), Base.Iterators.Pairs{Union{}, Union{}, Tuple{}, NamedTuple{(), Tuple{}}}, typeof(Base.open), getfield(Weave, Symbol("#72#73")){String}, String, Vararg{String, N} where N})
...
precompile(Tuple{typeof(Base.collect_to!), Array{Bool, 1}, Base.Generator{Array{String, 1}, getfield(Weave.WeaveMarkdown, Symbol("#49#50")){Markdown.LaTeX}}, Int64, Int64})
precompile(Tuple{typeof(Base.collect), Base.Generator{Array{String, 1}, getfield(Weave.WeaveMarkdown, Symbol("#49#50")){Markdown.LaTeX}}})
...
precompile(Tuple{typeof(Base.diff_names), Tuple{Symbol, Symbol, Symbol, Symbol}, Tuple{Symbol, Symbol, Symbol, Symbol, Symbol, Symbol, Symbol, Symbol, Symbol, Symbol, Symbol, Symbol, Symbol, Symbol, Symbol}})
...
precompile(Tuple{getfield(Weave, Symbol("##weave#16")), String, Symbol, String, Base.Dict{Any, Any}, Symbol, String, Nothing, String, Symbol, Bool, String, Nothing, Nothing, Array{String, 1}, String, typeof(Weave.weave), String})
precompile(Tuple{typeof(Main.mmtest), String, String, String})
precompile(Tuple{Type{NamedTuple{(:doctype, :mod, :out_path, :args, :fig_path, :fig_ext, :cache_path, :cache, :throw_errors), T} where T<:Tuple}, Tuple{String, Symbol, String, Base.Dict{Any, Any}, String, Nothing, String, Symbol, Bool}})
precompile(Tuple{getfield(Weave, Symbol("##run#34")), String, Symbol, String, Base.Dict{Any, Any}, String, Nothing, String, Symbol, Bool, typeof(Base.run), Weave.WeaveDoc})
precompile(Tuple{getfield(Base, Symbol("#kw##run")), NamedTuple{(:doctype, :mod, :out_path, :args, :fig_path, :fig_ext, :cache_path, :cache, :throw_errors), Tuple{String, Symbol, String, Base.Dict{Any, Any}, String, Nothing, String, Symbol, Bool}}, typeof(Base.run), Weave.WeaveDoc})
...
precompile(Tuple{typeof(Base.collect_to!), Array{Nothing, 1}, Base.Generator{Array{Char, 1}, getfield(WeaveSandBox11, Symbol("#1#2")){Base.GenericIOBuffer{Array{UInt8, 1}}}}, Int64, Int64})
precompile(Tuple{typeof(Base.collect), Base.Generator{Array{Char, 1}, getfield(WeaveSandBox11, Symbol("#1#2")){Base.GenericIOBuffer{Array{UInt8, 1}}}}})
...
precompile(Tuple{typeof(Base.collect_to!), Array{Nothing, 1}, Base.Generator{Array{Int64, 1}, getfield(WeaveSandBox11, Symbol("#1#2")){Base.GenericIOBuffer{Array{UInt8, 1}}}}, Int64, Int64})
precompile(Tuple{typeof(Base.collect), Base.Generator{Array{Int64, 1}, getfield(WeaveSandBox11, Symbol("#1#2")){Base.GenericIOBuffer{Array{UInt8, 1}}}}})
...
precompile(Tuple{typeof(Base.collect_to!), Array{Nothing, 1}, Base.Generator{Array{Char, 1}, getfield(WeaveSandBox12, Symbol("#5#6")){Base.GenericIOBuffer{Array{UInt8, 1}}}}, Int64, Int64})
precompile(Tuple{typeof(Base.collect), Base.Generator{Array{Char, 1}, getfield(WeaveSandBox12, Symbol("#5#6")){Base.GenericIOBuffer{Array{UInt8, 1}}}}})
...
precompile(Tuple{typeof(Base.collect_to!), Array{Nothing, 1}, Base.Generator{Array{Int64, 1}, getfield(WeaveSandBox12, Symbol("#5#6")){Base.GenericIOBuffer{Array{UInt8, 1}}}}, Int64, Int64})
precompile(Tuple{typeof(Base.collect), Base.Generator{Array{Int64, 1}, getfield(WeaveSandBox12, Symbol("#5#6")){Base.GenericIOBuffer{Array{UInt8, 1}}}}})
...
precompile(Tuple{typeof(Base.collect_to!), Array{Nothing, 1}, Base.Generator{Array{Char, 1}, getfield(WeaveSandBox13, Symbol("#3#4")){Base.GenericIOBuffer{Array{UInt8, 1}}}}, Int64, Int64})
precompile(Tuple{typeof(Base.collect), Base.Generator{Array{Char, 1}, getfield(WeaveSandBox13, Symbol("#3#4")){Base.GenericIOBuffer{Array{UInt8, 1}}}}})
...
precompile(Tuple{typeof(Base.collect_to!), Array{Nothing, 1}, Base.Generator{Array{Int64, 1}, getfield(WeaveSandBox13, Symbol("#3#4")){Base.GenericIOBuffer{Array{UInt8, 1}}}}, Int64, Int64})
precompile(Tuple{typeof(Base.collect), Base.Generator{Array{Int64, 1}, getfield(WeaveSandBox13, Symbol("#3#4")){Base.GenericIOBuffer{Array{UInt8, 1}}}}})
...
precompile(Tuple{getfield(Weave, Symbol("##weave#16")), String, Symbol, String, Base.Dict{Any, Any}, Symbol, String, Nothing, String, Symbol, Bool, Nothing, Nothing, Nothing, Array{String, 1}, String, typeof(Weave.weave), String})
...
precompile(Tuple{typeof(Weave.eval_chunk), Weave.CodeChunk, Weave.Report, Module})
precompile(Tuple{typeof(Weave.run_chunk), Weave.CodeChunk, Weave.WeaveDoc, Weave.Report, Module})
precompile(Tuple{getfield(Weave, Symbol("##run#34")), Symbol, Symbol, Symbol, Base.Dict{Any, Any}, String, Nothing, String, Symbol, Bool, typeof(Base.run), Weave.WeaveDoc})
...
precompile(Tuple{getfield(Plots, Symbol("#297#298"))})
precompile(Tuple{typeof(Base.get), getfield(Plots, Symbol("#297#298")), Base.Dict{String, Function}, Base.SubString{String}})
...
precompile(Tuple{typeof(Base.diff_names), Tuple{Symbol, Symbol, Symbol}, Tuple{Symbol, Symbol, Symbol, Symbol, Symbol, Symbol, Symbol, Symbol, Symbol, Symbol, Symbol, Symbol, Symbol, Symbol, Symbol}})
...
precompile(Tuple{getfield(Weave, Symbol("##weave#16")), String, Symbol, String, Base.Dict{Any, Any}, Symbol, String, String, String, Symbol, Bool, Nothing, Nothing, Nothing, Array{String, 1}, String, typeof(Weave.weave), String})
...
precompile(Tuple{getfield(YAML, Symbol("##construct_object#5")), Bool, typeof(YAML.construct_object), YAML.Constructor, YAML.ScalarNode})
precompile(Tuple{getfield(YAML, Symbol("#kw##construct_object")), NamedTuple{(:deep,), Tuple{Bool}}, typeof(YAML.construct_object), YAML.Constructor, YAML.ScalarNode})
precompile(Tuple{getfield(YAML, Symbol("#kw##construct_object")), NamedTuple{(:deep,), Tuple{Bool}}, typeof(YAML.construct_object), YAML.Constructor, YAML.MappingNode})
...
precompile(Tuple{Type{NamedTuple{(:doctype, :mod, :out_path, :args, :fig_path, :fig_ext, :cache_path, :cache, :throw_errors), T} where T<:Tuple}, Tuple{String, Symbol, String, Base.Dict{Any, Any}, String, String, String, Symbol, Bool}})
precompile(Tuple{typeof(Weave.set_rc_params), Weave.WeaveDoc, String, String})
precompile(Tuple{getfield(Weave, Symbol("##run#34")), String, Symbol, String, Base.Dict{Any, Any}, String, String, String, Symbol, Bool, typeof(Base.run), Weave.WeaveDoc})
precompile(Tuple{getfield(Base, Symbol("#kw##run")), NamedTuple{(:doctype, :mod, :out_path, :args, :fig_path, :fig_ext, :cache_path, :cache, :throw_errors), Tuple{String, Symbol, String, Base.Dict{Any, Any}, String, String, String, Symbol, Bool}}, typeof(Base.run), Weave.WeaveDoc})
precompile(Tuple{typeof(Base.create_expr_cache), String, String, Array{Base.Pair{Base.PkgId, UInt64}, 1}, Base.UUID})
...
precompile(Tuple{typeof(Base.isequal), Gadfly.Guide.BottomGuidePosition, Gadfly.Guide.OverGuidePosition})
...
precompile(Tuple{typeof(YAML.parse_document_start), YAML.EventStream})
precompile(Tuple{typeof(YAML.parse_implicit_document_start), YAML.EventStream})
precompile(Tuple{typeof(Base.convert), Type{Any}, UInt64})
precompile(Tuple{typeof(Base.convert), Type{Any}, YAML.SimpleKey})
precompile(Tuple{getfield(YAML, Symbol("##parse_node#2")), Bool, Bool, typeof(YAML.parse_node), YAML.EventStream})
precompile(Tuple{typeof(YAML.parse_block_node), YAML.EventStream})
precompile(Tuple{typeof(YAML.compose_node), YAML.Composer, YAML.MappingNode, Nothing})
precompile(Tuple{typeof(YAML.compose_mapping_node), YAML.Composer, Nothing})
...
precompile(Tuple{typeof(Base.haskey), Base.Dict{AbstractString, AbstractString}, String})
precompile(Tuple{typeof(Base.getindex), Base.Dict{AbstractString, AbstractString}, String})
precompile(Tuple{Type{YAML.DocumentStartEvent}, YAML.Mark, YAML.Mark, Bool, Nothing, Base.Dict{AbstractString, AbstractString}})
...
precompile(Tuple{getfield(Weave, Symbol("##weave#16")), String, Symbol, Symbol, Base.Dict{Any, Any}, Symbol, String, Nothing, String, Symbol, Bool, Mustache.MustacheTokens, Nothing, Nothing, Array{String, 1}, String, typeof(Weave.weave), String})
...
precompile(Tuple{typeof(Weave.run_inline), Weave.InlineCode, Weave.WeaveDoc, Weave.Report, Module})
precompile(Tuple{getfield(Weave, Symbol("#39#40")){Weave.WeaveDoc, Weave.Report, Module}, Weave.InlineCode})
precompile(Tuple{Type{WeaveSandBox34.Begin}, String, String})
precompile(Tuple{typeof(Base.:(!=)), WeaveSandBox34.Begin, Nothing})
precompile(Tuple{typeof(Base.Multimedia.display), Weave.Report, WeaveSandBox34.Begin})
precompile(Tuple{typeof(Base.show), Base.GenericIOBuffer{Array{UInt8, 1}}, Base.Multimedia.MIME{Symbol("text/html")}, WeaveSandBox34.Begin})
precompile(Tuple{getfield(Base.Multimedia, Symbol("##repr#1")), Nothing, typeof(Base.repr), Base.Multimedia.MIME{Symbol("text/html")}, WeaveSandBox34.Begin})
precompile(Tuple{typeof(Base.Multimedia.display), Weave.Report, Base.Multimedia.MIME{Symbol("text/html")}, WeaveSandBox34.Begin})
precompile(Tuple{typeof(Base.collect_to!), Array{Weave.Inline, 1}, Base.Generator{Array{Weave.Inline, 1}, getfield(Weave, Symbol("#39#40")){Weave.WeaveDoc, Weave.Report, Module}}, Int64, Int64})
precompile(Tuple{Type{WeaveSandBox34.End}, String})
precompile(Tuple{typeof(Base.:(!=)), WeaveSandBox34.End, Nothing})
precompile(Tuple{typeof(Base.Multimedia.display), Weave.Report, WeaveSandBox34.End})
precompile(Tuple{typeof(Base.Multimedia._textrepr), Base.Multimedia.MIME{Symbol("text/html")}, WeaveSandBox34.End, Nothing})
precompile(Tuple{getfield(Base.Multimedia, Symbol("##repr#1")), Nothing, typeof(Base.repr), Base.Multimedia.MIME{Symbol("text/html")}, WeaveSandBox34.End})
precompile(Tuple{typeof(Base.Multimedia.display), Weave.Report, Base.Multimedia.MIME{Symbol("text/html")}, WeaveSandBox34.End})
...
precompile(Tuple{Type{WeaveSandBox35.Begin}, String, String})
precompile(Tuple{typeof(Base.:(!=)), WeaveSandBox35.Begin, Nothing})
precompile(Tuple{typeof(Base.Multimedia.display), Weave.Report, WeaveSandBox35.Begin})
precompile(Tuple{typeof(Base.show), Base.GenericIOBuffer{Array{UInt8, 1}}, Base.Multimedia.MIME{Symbol("text/latex")}, WeaveSandBox35.Begin})
precompile(Tuple{getfield(Base.Multimedia, Symbol("##repr#1")), Nothing, typeof(Base.repr), Base.Multimedia.MIME{Symbol("text/latex")}, WeaveSandBox35.Begin})
precompile(Tuple{typeof(Base.Multimedia.display), Weave.Report, Base.Multimedia.MIME{Symbol("text/latex")}, WeaveSandBox35.Begin})
precompile(Tuple{Type{WeaveSandBox35.End}, String})
precompile(Tuple{typeof(Base.:(!=)), WeaveSandBox35.End, Nothing})
precompile(Tuple{typeof(Base.Multimedia.display), Weave.Report, WeaveSandBox35.End})
precompile(Tuple{typeof(Base.show), Base.GenericIOBuffer{Array{UInt8, 1}}, Base.Multimedia.MIME{Symbol("text/latex")}, WeaveSandBox35.End})
precompile(Tuple{getfield(Base.Multimedia, Symbol("##repr#1")), Nothing, typeof(Base.repr), Base.Multimedia.MIME{Symbol("text/latex")}, WeaveSandBox35.End})
precompile(Tuple{typeof(Base.Multimedia.display), Weave.Report, Base.Multimedia.MIME{Symbol("text/latex")}, WeaveSandBox35.End})
...
precompile(Tuple{typeof(Base.show_unquoted), Base.PipeEndpoint, Symbol, Int64, Int64})
precompile(Tuple{typeof(Base.print), Base.PipeEndpoint, Char, Char})
precompile(Tuple{typeof(Base.escape_string), Base.PipeEndpoint, String, Tuple{Char, Char}})
precompile(Tuple{typeof(Base.print_quoted), Base.PipeEndpoint, String})
precompile(Tuple{typeof(Base.show_unquoted), Base.PipeEndpoint, String, Int64, Int64})
