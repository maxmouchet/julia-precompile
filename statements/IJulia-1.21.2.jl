...
precompile(Tuple{getfield(Base, Symbol("##open#270")), Base.Iterators.Pairs{Union{}, Union{}, Tuple{}, NamedTuple{(), Tuple{}}}, typeof(Base.open), getfield(IJulia, Symbol("#2#3")){Base.Dict{String, Any}}, String, Vararg{String, N} where N})
...
precompile(Tuple{getfield(Base, Symbol("##sprint#338")), Nothing, Int64, typeof(Base.sprint), Function, UndefVarError, Vararg{Any, N} where N})
...
precompile(Tuple{getfield(Base, Symbol("##showerror#648")), Bool, typeof(Base.showerror), Base.GenericIOBuffer{Array{UInt8, 1}}, UndefVarError, Array{Union{Ptr{Nothing}, Base.InterpreterIP}, 1}})
...
precompile(Tuple{getfield(Base, Symbol("##with_output_color#701")), Bool, typeof(Base.with_output_color), Function, Symbol, Base.DevNull, Char})
...
precompile(Tuple{getfield(Base, Symbol("##sprint#338")), Nothing, Int64, typeof(Base.sprint), Function, Base.Dict{String, Union{String, JSON.Writer.JSONText}}})
